...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="relative py-20 md:py-28 bg-white">
      ...
      >
        <img src={"/bg-faq-right.svg"} alt="" loading="lazy" className="w-full h-full object-contain" />
      </div>
      ...
      >
        <div className="-rotate-90 flex-none" style={{ height: '100cqw', width: '100cqh' }}>
          <img src={"/bg-faq-left.svg"} alt="" loading="lazy" className="absolute block inset-0 max-w-none w-full h-full" />
        </div>
      </div>
