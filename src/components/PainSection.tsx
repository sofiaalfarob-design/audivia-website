      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 items-center">
        ...
        >
          <div className="relative">
            {/* Blue circle */}
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-[400px] lg:h-[400px] bg-[#1B3A6B] rounded-full overflow-hidden">
              <Image
            ...
            {/* Badge "Mejor proceso" */}
            <div className="badge-float absolute top-8 -left-4 sm:-left-8 bg-white border-2 border-[#E8541A] rounded-xl shadow-lg px-4 py-2">
              <p className="text-[#1B3A6B] font-bold text-sm">Mejor proceso</p>
            </div>

            {/* Badge "Audífonos con 2 años de garantía" */}
            <div className="absolute bottom-8 -right-2 sm:-right-6 bg-white border-2 border-[#E8541A] rounded-xl shadow-lg px-4 py-3 max-w-[180px]">
              <p className="text-[#1B3A6B] font-bold text-sm leading-snug">Audífonos con 2 años de garantía</p>
            </div>
          </div>
        </div>
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1B3A6B] leading-tight mb-6">
          ...
          <ul className="space-y-3 mb-6">
            {painPoints.map((point, i) => (
              <li key={i} className="flex items-start gap-3 text-gray-600">
                <span className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-[#E8541A] flex items-center justify-center">
